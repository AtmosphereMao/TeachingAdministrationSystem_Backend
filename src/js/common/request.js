...
const Request = {
  ...
  Video: {
    ...
    Upload(param) {
      return Ajax.upload('/video/token/huawei/block', param);
    },
    SmallUpload(param) {
      return Ajax.upload('/video/token/huawei', param);
    }
  },
  /** 课程标签 */
  Tag: {
    List() {
      return Ajax.get('/courseTag');
    },
    Create(param) {
      return Ajax.postJson('/courseTag', param);
    },
    Delete(param) {
      return Ajax.delete('/courseTag/' + param.id, param);
    },
    Edit(param) {
      return Ajax.get('/courseTag/' + param.id);
    },
    Update(param) {
      return Ajax.putJson('/courseTag/' + param.id, param);
    }
  },
  CourseChapter: {
    List(param) {
