    ...
    <div class="table-basic-vue frame-page h-panel">
      ...
      <div class="h-panel-body">
        ...
        <Form ref="form" mode="block" :validOnChange="true" :showErrorTip="true" :labelWidth="110" :rules="rules" :model="video">
          ...
          <FormItem label="华为云视频ID" prop="huawei_video_id" v-show="tab === '华为云'">
            <template v-slot:label>华为云视频ID</template>
            <huawei-video v-model="video.huawei_video_id"></huawei-video>
          </FormItem>
...
import HuaweiVideo from '../common/video/huawei/huawei';
